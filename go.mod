...
require (
	github.com/J-Siu/go-gitapi/v3 v3.0.8
	github.com/J-Siu/go-gitcmd/v3 v3.0.1
...
require (
	github.com/J-Siu/go-crypto v1.1.5 // indirect
	github.com/J-Siu/go-restapi v1.0.5 // indirect
